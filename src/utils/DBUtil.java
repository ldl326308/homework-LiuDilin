...
public class DBUtil {
	...
	static String DBURL ="jdbc:mysql://localhost:3306/PhoneDB?serverTimezone=GMT%2B8";
...
//			System.out.println("读取"+DBDRIVER);
//			System.out.println("读取"+DBURL);
//			System.out.println("读取"+DBUSER);
//			System.out.println("读取"+DBPWD);
//		} catch (IOException e) {
